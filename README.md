...
| 🤖 **Guía técnica**          | Manual técnico completo: arquitectura, agente de voz, modelo de datos, las 14 vistas una por una, pruebas, despliegue y **el código fuente completo** (57 archivos, 17.787 líneas) y 32 capturas actualizadas, 268 pág. → **[PDF](docs/Guia_Tecnica_CuentaVoz_V5.pdf)** · fuente → **[HTML](docs/guia_tecnica/guia.html)** |
