...
| 📖 **Manual de usuario**     | Guía de capacitación para el personal de bodega, en el orden del menú y con paso a paso en cada pantalla, 43 pág., con índice numerado y navegable → **[PDF](docs/Manual_Usuario_CuentaVoz_V2.pdf)** |
