...
| 🤖 **Guía técnica**          | Manual técnico completo: arquitectura, agente de voz, modelo de datos, autenticación, pruebas, despliegue, las 14 vistas con **todas sus subvistas** (74 capturas), y **el código fuente completo** (76 archivos, 21.448 líneas), 399 pág. → **[PDF](docs/Guia_Tecnica_CuentaVoz_V5.pdf)** |
| 📖 **Manual de usuario**     | Guía de capacitación para el personal de bodega, en el orden del menú y con paso a paso en cada pantalla, 43 pág. → **[PDF](docs/Manual_Usuario_CuentaVoz_V2.pdf)** |
